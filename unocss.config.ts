...
export default defineConfig({
  ...
  safelist: [
    'i-iconoir:home', 'i-iconoir:settings', 'i-iconoir:google-docs', 'i-iconoir:bookmark-book', 'i-iconoir:network-right', 'i-iconoir:open-new-window', 'i-iconoir:align-right', 'i-iconoir:adobe-photoshop-solid',
